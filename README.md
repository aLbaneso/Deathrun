...
### Setup
1. Modify `scripting/include/settings.inc` to configure your database and complie the files
2. Start the server, mod will take care of the SQL table creation

### TODO
Working on a php server to view other players' runs
